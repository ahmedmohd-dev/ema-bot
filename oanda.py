...
API_KEY = "2f10b7f6cd6340e69181a383b5db7cca"
...
print("✅ TWELVE DATA EMA BOT STARTED")
...
while True:
    ...
    try:
        ...
        logging.info(f"New Candle: {current_bar_time}")
